...
//get location permission and location details
  getLocs() async {
    ...
    final Uint8List deliveryIcons =
        await getBytesFromAsset('assets/images/deliveryicon.png', 80);
    ...
    final Uint8List autoIcons =
        await getBytesFromAsset('assets/images/auto.png', 80);
    autoIcon = BitmapDescriptor.fromBytes(autoIcons);
                                                                                        ...
                                                                                        ? Row(
                                                                                            children: [
                                                                                              Container(
                                                                                                ...
                                                                                                decoration:(choosenTransportType == 0)? BoxDecoration(
                                                                                    ...
                                                                                    ? (userDetails['enable_modules_for_applications'] == 'both' || userDetails['enable_modules_for_applications'] == 'delivery')
                                                                                        ? Row(
                                                                                            children: [
                                                                                              // ),
                                                                                              Container(
                                                                                                  decoration:(choosenTransportType == 1)? BoxDecoration(
                                                                                                  border: Border.all(width: 1),
                                                                                                  color: Colors.amber,
                                                                                                  borderRadius: BorderRadius.circular(20)
                                                                                                ) : BoxDecoration(
